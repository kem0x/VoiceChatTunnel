...
namespace ImGui
{
    ...
    IMGUI_API void TextStyled(const char* text, float fontSize, ImU32 color);
    ...
    IMGUI_API bool ColoredButton(const char* label, const ImVec2& size_arg, ImU32 text_color, ImU32 bg_color_1, ImU32 bg_color_2, float rounding = 0);

    IMGUI_API bool ClickableText(const char* string);
